...
class DialogApp(QMainWindow):
    ...
    def help(self):
        ...
        msg.setText("The roll for mod button only works in the currency stash tab. Type the mod you want to roll in the currency tab text box. There is a 3 second delay until the program begins.1. Click roll for mod button. 2. Choose currency 3. Mouseover item. 4. Program ends once mod is found. Hold 'alt' to stop program.")
        msg.exec_()
